...
OUTPUT_FILE = "project_structure31.md"
...
/* 🟢 تحسين توزيع الخلايا لمنع التباعد الأفقي المشوه */
.info-table td.label { font-weight: bold; width: 30%; text-align: start; }
.info-table td.value { text-align: end; width: 70%; font-weight: 600; }
...
.note-box { border: 1px solid #000; border-radius: 4px; padding: 2mm; font-size: 11px; margin: 3mm 0; min-height: 8mm; text-align: start; }
...
/* 🖨️ قاعدة التحكم بالطباعة الحرارية الذكية الصارمة دون التأثير على الشاشة */
@media print {
    @page {
        size: 80mm auto;
    ...
    /* 🟢 إجبار جميع الحاويات الأبوية لـ React و Tailwind على الانكماش لـ 80مم منبعًا للمساحة البيضاء */
    ...
    /* إجبار إيصال الـ React على أبعاد رأس الطابعة Posbank A7 */
    .printable-area.receipt-ticket {
    ...
    /* 🟢 التحكم بمحاذاة نصوص الجدول بدقة شديدة عند الطباعة */
    .info-table {
        width: 100% !important;
    }
    .info-table td.label { 
    ...
    /* جعل القيم تلتصق تمامًا بالناحية المعاكسة لمنع الفراغات */
    .info-table td.value { 
        width: 65% !important; 
        text-align: end !important;
    }

    .receipt-ticket, table, tr {
        page-break-inside: avoid !important;
    }

    /* 🔵 تنسيق A4 للتقارير الكبيرة فقط */
    .print-a4 {
