...
OUTPUT_FILE = "project_structure13.md"
...
```json
{
  ...
  "hr": {
    ...
    "dialog": {
      ...
      "name": "الاسم الكامل",
      "namePlaceholder": "مثال: يحيى جباري الزعيم",
      "role": "المنصب",
  ...
  "settings": {
    ...
    "subtitle": "إضافة وتعديل حسابات النظام (كاشير / مدير)",
    "newUser": "مستخدم جديد",
  ...
  "database": {
    ...
    "backupDesc": "حفظ نسخة من جميع بيانات النظام (المصاريف، العمال، الإعدادات) في ملف خارجي للحماية من الفقدان.",
    ...
    "messages": {
      ...
      "restoreConfirm": "تحذير: استعادة البيانات ستحذف البيانات الحالية وتحل محلها. هل أنت متأكد؟",
      "error": "حدث خطأ أثناء العملية. يرجى المحاولة مرة أخرى."
    }
  },
  "audit": {
    "actions": {
...
```json
{
  ...
  "dashboard": {
    ...
    "lists": {
      "urgentAlerts": "Urgent Agenda Alerts",
      "recentAudit": "Recent Audit Logs",
      "noAuditLogs": "No activities recorded yet.",
  ...
  "hr": {
    ...
    "roles": {
      ...
      "scale": "Balance worker",
      "stock": "Stock Merchandiser",
      "admin": "Admin"
    },
    "dialog": {
      ...
      "role": "Position",
      "rolePlaceholder": "-- Select Position --",
      "pin": "PIN Code",
      "cancel": "Cancel",
      "save": "Save Employee",
  ...
  "settings": {
    ...
    "subtitle": "Add and manage system accounts (Cashier / Admin)",
    "newUser": "New User",
    "errorFillFields": "Please enter a username and password",
    "username": "Username",
    "usernamePlaceholder": "e.g. cashier1",
    "password": "Password",
    "passwordPlaceholder": "••••••••",
    "role": "Role (Permission Level)",
    "roleCashier": "Cashier (Limited Permissions)",
    ...
    "deleteAlert": "You cannot delete your current account or the main admin account.",
  ...
  "database": {
    ...
    "backupDesc": "Save a copy of all system data (expenses, employees, settings) to an external file to prevent loss.",
    "restoreDesc": "Restore system data from a previous backup file.",
    "messages": {
      "backupSuccess": "Backup saved successfully!",
      "restoreSuccess": "Data restored successfully! The system will restart.",
      "restoreConfirm": "WARNING: Restoring data will overwrite all current data. Are you sure?",
  ...
  "audit": {
    ...
    "details": {
      "ADD_EXPENSE": "Added expense: {{desc}} for {{amount}} DA",
      "DELETE_EXPENSE": "Deleted expense: {{desc}} for {{amount}} DA",
