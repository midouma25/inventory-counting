...
OUTPUT_FILE = "project_structure38.md"
...
<head>
  <meta charset="UTF-8">
  <title>POS Client - الاتصال بالسيرفر</title>
  <style>
    body {
      font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
      background-color: #0f172a; /* لون داكن يتناسب مع تصميمك */
      color: #e2e8f0;
      display: flex;
      flex-direction: column;
      align-items: center;
...
<body>
  <div class="container">
    <h2>نظام الكاشير (النسخة الطرفية)</h2>
    <p>يرجى إدخال عنوان الـ IP الخاص بالحاسوب الرئيسي:</p>
    
    <input type="text" id="ipInput" placeholder="مثال: 192.168.1.5" />
  ...
  <script>
    ...
    function connectToServer() {
      ...
      if (ip) {
        ...
        // استبدل 5000 برقم الـ PORT الخاص بالـ Express في الباك اند عندك
        const port = 3000; 
        
        // التوجه فوراً إلى شاشة البرنامج الرئيسي عبر الشبكة!
...
```json
{
  ...
  "build": {
    "appId": "com.gherbi.client",
    "productName": "POS Client",
    "win": {
      "target": "portable"
    }
  }
...
// 🔴 ضع نفس الكلمة السرية الموجودة في ملف .env تماماً!
const SECRET_SALT = "GHERBI_AI_SUPER_SECRET_POS_2026_V1"; 

// ضع رقم الجهاز (Machine ID) الذي يظهلك في الشاشة الحمراء هنا
const customerHardwareId = "AA031B9C-287E-4BBD-BBB4-74EBE8A4AC81";
...
console.log("-----------------------------------------");
console.log("🔐 أداة توليد مفاتيح الترخيص - M.Cherif 🔐");
console.log("رقم جهاز العميل :", customerHardwareId);
console.log("مفتاح التفعيل   :", generateKey(customerHardwareId));
console.log("-----------------------------------------");
```
