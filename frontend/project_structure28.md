...
@page receipt-a7 {
  size: A7 portrait; /* أو 74mm 105mm */
  margin: 0;
}
...
## `src\components\DailyClosuresArchive.jsx`
...
{/* 🔴 شاشة طباعة الوصل (X-Report) بحجم A7 */}
{/* 🔴 شاشة طباعة الوصل (X-Report) بحجم A7 */}
              <div className="printable-area print-a7 bg-white text-black mx-auto flex flex-col font-mono" dir={isRTL ? "rtl" : "ltr"}>
                
                <div className="text-center mb-4">
                  <h2 className="text-xl font-black mb-1"><bdi>{t('eod.store_name')}</bdi></h2>
                  <div className="border-b-2 border-dashed border-black pb-2 mt-2">
                    <p className="font-bold text-lg">{t('eod.x_report')}</p>
                    <p className="text-[10px] mt-1">{new Date().toLocaleDateString(i18n.language)}</p>
                  </div>
                </div>

                <div className="space-y-2 mb-4 border-b-2 border-dashed border-black pb-4 text-start text-[11px]">
                  <div className="flex justify-between items-center gap-2">
                    <span className="font-bold whitespace-nowrap">{t('eod.cashierName')}:</span>
                    <span className="text-end truncate max-w-[100px]">{receiptData.cashier}</span>
                  </div>
                  <div className="flex justify-between items-center gap-2">
                ...
                <div className="space-y-2 mb-4 border-b-2 border-dashed border-black pb-4 text-start text-[11px]">
                  ...
                  <div className="flex justify-between items-center gap-2 bg-gray-100 p-1 -mx-1 px-1">
                    ...
                    <span className="font-bold text-sm text-end"><bdi>{(receiptData.actual || 0).toLocaleString()} {t('currency')}</bdi></span>
                  </div>
                </div>

                <div className="flex justify-between items-center text-sm font-bold mb-4 bg-black text-white p-2 rounded-sm text-start">
                ...
                <div className="mt-auto text-center text-[9px] space-y-1">
                   <p className="border-t-2 border-dashed border-black pt-2">{t('eod.receipt_footer')}</p>
...
## `src\components\ExpensesPieChart.jsx`
...
## `src\components\pages\AuditLogs.jsx`
...
## `src\components\pages\Employees.jsx`
...
## `src\components\pages\Expenses.jsx`
...
<form onSubmit={handleCalculate} className="space-y-4 text-start">
              <div>
                <label className="block text-sm font-medium text-slate-400 mb-2">{t('payroll.selectEmployee', 'اختر الموظف')}</label>
                <select required value={selectedEmployee} onChange={e => setSelectedEmployee(e.target.value)} className="w-full bg-slate-950 border border-slate-700 rounded-lg py-2.5 px-4 text-white focus:outline-none focus:border-blue-500 text-start">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  {/* 🔴 استخدام الترجمة لكلمة (من / From) */}
                  <label className="block text-sm font-medium text-slate-400 mb-2">{t('agenda.modal.dateLabel', 'التاريخ')} ({t('common.from', 'من')})</label>
                  <input type="date" required value={startDate} onChange={e => setStartDate(e.target.value)} className="w-full bg-slate-950 border border-slate-700 rounded-lg py-2.5 px-4 text-white focus:outline-none focus:border-blue-500 text-start" />
                </div>
                <div>
                  {/* 🔴 استخدام الترجمة لكلمة (إلى / To) */}
                  <label className="block text-sm font-medium text-slate-400 mb-2">{t('agenda.modal.dateLabel', 'التاريخ')} ({t('common.to', 'إلى')})</label>
                  <input type="date" required value={endDate} onChange={e => setEndDate(e.target.value)} className="w-full bg-slate-950 border border-slate-700 rounded-lg py-2.5 px-4 text-white focus:outline-none focus:border-blue-500 text-start" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-400 mb-2">{t('payroll.hourlyRate', 'سعر الساعة')} ({t('currency', 'د.ج')})</label>
                <input type="number" required min="1" value={hourlyRate} onChange={e => setHourlyRate(e.target.value)} placeholder="150" className="w-full bg-slate-950 border border-slate-700 rounded-lg py-2.5 px-4 text-white focus:outline-none focus:border-blue-500 text-start" />
              </div>
          ...
          <div className="lg:col-span-2">
            {!payrollResult ? (
              <div className="h-full bg-slate-900/50 border border-slate-800 border-dashed rounded-xl flex flex-col items-center justify-center text-slate-500 p-12 min-h-[400px]">
                ...
                <p className="text-center">{t('payroll.emptyStateDesc', 'أدخل بيانات الموظف واضغط على "حساب الراتب" لظهور النتيجة')}</p>
              </div>
            ) : (
...
## `src\components\pages\PrintPreview.jsx`
...
## `src\components\ui\ConfirmAlert.jsx`
...
## `src\components\ui\PrintablePayrollReport.jsx`
...
## `src\components\ui\PrintablePayslip.jsx`
...
## `src\components\ui\PrintableTicket.jsx`
