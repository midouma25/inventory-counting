...
OUTPUT_FILE = "project_structure25.md"
            ...
            <div>
              ...
              {selectedReport.shifts.length === 0 ? (
                <div className="text-center p-6 border-2 border-dashed border-gray-300 text-gray-500 flex flex-col items-center gap-2">
                   <AlertCircle size={32} />
                   <p>تفاصيل الورديات غير متوفرة لهذا الأرشيف القديم.<br/>(تم إغلاق هذا اليوم قبل تفعيل ميزة الربط المتقدمة)</p>
                </div>
              ) : (
              ...
              <table className="w-full text-start border-collapse" dir={i18n.dir()}>
                <thead>
                  <tr className="border-b border-slate-800 bg-slate-950/80">
                    ...
                    <th className="px-6 py-4 text-sm font-medium text-slate-400 text-center">إجراء</th>
                  </tr>
                </thead>
                <tbody>
                  {isLoading ? (
                    ...
                    <tr><td colSpan="6" className="text-center py-12 text-slate-500">لا توجد سجلات محفوظة بعد.</td></tr>
                  ) : (
                    closures.map(c => (
...
import { LayoutDashboard, Users, Briefcase, Receipt, Calendar, Banknote, Settings, Archive } from 'lucide-react';
