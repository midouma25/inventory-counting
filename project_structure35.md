...
OUTPUT_FILE = "project_structure35.md"
...
```json
{
  ...
  "storeMap": {
    "title": "نظام الهايبر ماركت التفاعلي",
    "subtitle": "مراقبة {{count}} نقطة تخزين حية",
    "searchPlaceholder": "ابحث عن رف أو قسم...",
    "searchResults": "نتائج البحث",
    "showingShelves": "يتم عرض {{count}} رف",
    "status": {
      "good": "جيد",
      "low": "منخفض",
      "empty": "فارغ!"
    ...
    "zones": {
      "food": "الغذائية والمصبرات",
      "fresh": "الثلاجات والطازج",
      "cleaning": "مواد التنظيف",
      "electronics": "الإلكترونيات والأجهزة",
      "clothing": "الملابس والنسيج",
      "beauty": "العناية الشخصية والتجميل"
    },
    "shelfName": "رف {{num}} - ممر {{aisle}}"
  },
  "pdfImporter": {
    "title": "المستورد الذكي للمخزون (Smart PDF)",
    "subtitle": "قم برفع وصولات الاستلام وسيتم استخراج السلع وربطها بالخريطة آلياً.",
    "btnUpload": "رفع وتحليل PDF",
...
```json
{
 ...
 "storeMap": {
    "title": "Interactive Hypermarket",
    "subtitle": "Monitoring {{count}} live storage points",
    "searchPlaceholder": "Search for a shelf or zone...",
    "searchResults": "Search Results",
    "showingShelves": "Showing {{count}} shelves",
    "status": {
      "good": "Good",
      "low": "Low",
      "empty": "Empty!"
    ...
    "shelfName": "Shelf {{num}} - Aisle {{aisle}}"
  
  },
  "pdfImporter": {
    "title": "Smart PDF Inventory Importer",
    "subtitle": "Upload and analyze PDF invoices, and automatically extract and map products to shelves.",
    "btnUpload": "Upload and Analyze PDF",
...
"storeMap": {
    "title": "Hypermarché Interactif",
    "subtitle": "Surveillance de {{count}} points de stockage",
    "searchPlaceholder": "Rechercher un rayon ou une zone...",
    "searchResults": "Résultats de recherche",
    "showingShelves": "Affichage de {{count}} rayons",
    "status": {
      "good": "Bon",
      "low": "Faible",
      "empty": "Vide!"
    ...
    "zones": {
      "food": "Alimentation et Conserves",
      "fresh": "Frais et Réfrigérateurs",
      "cleaning": "Produits d'entretien",
      "electronics": "Électronique",
      "clothing": "Vêtements",
      "beauty": "Beauté et Soins"
    },
    "shelfName": "Rayon {{num}} - Allée {{aisle}}"
  },
"pdfImporter": {
